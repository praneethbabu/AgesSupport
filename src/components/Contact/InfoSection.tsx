  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Address',
      content: 'Unit 4, 16 Kerr Street\nPark Avenue, QLD 4701',
      link: null,
    },
    {
      icon: Phone,
      title: 'Phone',
      content: '04 3576 7872',
      link: 'tel:0435767872',
    },
    {
      icon: Mail,
    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            We're here to help you. Reach out through any of the following methods,
              ...
              return (
                <div key={index} className="bg-gray-50 p-6 rounded-lg hover:shadow-lg transition-all duration-300">
                  ...
                  {item.link ? (
                    <a
                      href={item.link}
                      className="text-[#2ab5ac] hover:text-[#003366] transition-colors font-medium"
                      style={{ fontFamily: 'Cambria, serif' }}
                    >
                      {item.content}
                    </a>
